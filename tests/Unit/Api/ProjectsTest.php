...
it('creates a project', function () {
    ...
    Http::assertSent(fn($r) => $r->method() === RequestMethod::Post->value
        && $r->url() === "{$url}/projects"
        && $r->data() === $payload
    );
});
...
it('updates a project', function () {
    ...
    Http::assertSent(fn($r) => $r->method() === RequestMethod::Put->value
...
it('changes a user role in project', function () {
    ...
    Http::assertSent(fn($r) => $r->method() === RequestMethod::Patch->value
